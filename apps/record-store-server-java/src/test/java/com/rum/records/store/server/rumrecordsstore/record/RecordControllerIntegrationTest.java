...
import com.rum.records.store.server.rumrecordsstore.RumRecordsStoreApplication;
...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, classes = RumRecordsStoreApplication.class)
